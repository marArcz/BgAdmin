...
const AddForm = ({ handleClose, show, data, onSubmit }) => {
    ...
    const onFormSubmit = async (e) => {
        ...
        await onSubmit({name,price,description,category,images})
            ...
            <FormModal title="Add New Product" size="lg" handleClose={handleClose} show={show}>
                <form action="#" method="post" onSubmit={onFormSubmit}>
                    <div className="mb-3">
                        ...
                        <input type="file" accept='image/*,.png' multiple className='form-control d-none' id='file-select' onChange={onFileSelect} />
